...
// import { codeableConceptSchemaValidator, startSchemasValidators } from '@pegasimed.com/hl7-dev';
import { EXECUTE } from '../setup';
import { codeableConceptMock } from '../../src/mocks';
import {
  kafkaConsumer,
  kafkaProducer,
  getKafkaClient,
...
describe('utils', function () {
  ...
  //   await kafkaProducer(kafka, codeableConceptMock, 'test_payload');
